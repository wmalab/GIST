...
class embedding(torch.nn.Module):
    ...
    def __init__(self, in_dim, out_dim, in_num_channels):
        ...
        self.conv1d_3 = torch.nn.Conv1d(32, 6, 7, stride=3, padding=3, padding_mode='replicate')
        self.conv1d_4 = torch.nn.Conv1d(6, 1, 7, stride=3, padding=3, padding_mode='replicate')
